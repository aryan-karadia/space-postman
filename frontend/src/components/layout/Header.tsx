...
export function Header() {
  return (
    <header className="relative z-10 border-b border-void-700/50 bg-void-950/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
        <Link to="/" className="group flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-sm border border-neon-cyan/50 shadow-[0_0_10px_#00f5ff] transition-all group-hover:shadow-[0_0_15px_#00F0FF]">
